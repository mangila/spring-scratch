...
public class ActorScheduler {
    ...
    public ActorScheduler(SimpleAsyncTaskScheduler taskScheduler, StorageProvider storageProvider, ActorOutboxScheduler actorOutboxScheduler, LockingTaskExecutor lockingTaskExecutor, ActorProperties actorProperties) {
    ...
    public void init() {
        ...
        if (outbox.isEnabled()) {
            ...
            if (outbox.getRecover().isEnabled()) {
                ...
                final var task = new ActorOutboxRecoverTask(props, lockingTaskExecutor, storageProvider, actorOutboxScheduler);
                taskScheduler.schedule(task, new CronTrigger(props.getCron()));
            }
