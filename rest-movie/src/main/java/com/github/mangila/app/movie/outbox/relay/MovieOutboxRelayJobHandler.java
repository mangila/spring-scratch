...
public class MovieOutboxRelayJobHandler implements JobRequestHandler<MovieOutboxRelayJobRequest> {
	...
	public MovieOutboxRelayJobHandler(MovieOutboxRelayClaimStep movieOutboxRelayClaimStep,
			MovieOutboxRelayScheduleStep movieOutboxRelayScheduleStep,
			MovieOutboxRelayStatusStep movieOutboxRelayStatusStep, JsonMapper jsonMapper) {
