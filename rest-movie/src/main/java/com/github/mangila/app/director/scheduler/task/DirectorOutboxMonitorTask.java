...
public class DirectorOutboxMonitorTask implements Runnable {
	...
	public DirectorOutboxMonitorTask(DirectorOutboxMonitorProperties properties,
			LockingTaskExecutor lockingTaskExecutor, DirectorOutboxScheduler directorOutboxScheduler) {
