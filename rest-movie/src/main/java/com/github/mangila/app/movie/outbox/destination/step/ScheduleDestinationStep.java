...
public class ScheduleDestinationStep {
    ...
    public ScheduleDestinationStep(MovieOutboxScheduler movieOutboxScheduler) {
    ...
    public UUID execute(OutboxDestinationProjection outboxDestination) {
        ...
        var jobId = switch (destination) {
            ...
            case KAFKA -> movieOutboxScheduler.schedule(new MovieKafkaDestinationJobRequest(destinationId,destination));
            default ->
