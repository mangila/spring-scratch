...
public class MovieOutboxRecoverTask implements Runnable {
	...
	public MovieOutboxRecoverTask(MovieOutboxRecoverProperties properties, LockingTaskExecutor lockingTaskExecutor,
			StorageProvider storageProvider, MovieOutboxScheduler movieOutboxScheduler) {
